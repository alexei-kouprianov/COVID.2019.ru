...
**Коронавирус в России.** Графический update на **`r report.timestamp`**. Суммарное число зарегистрированных случаев по России ~ **`r report.RUS.i.cum`** тыс. Прирост за сутки -- **`r report.RUS.i.today`** тыс. Прирост связанных с COVID смертей за сутки: **`r report.RUS.d.today`**. Суммарный прирост за последние две недели на 100 тыс. населения -- **`r report.RUS.i.14.100`**. Суммарное по Москве -- **`r report.Moscow`** тыс., по Петербургу -- **`r report.SPb`** тыс. 

**Лидеры по абсолютному приросту за сутки**: 

```{r results='asis', echo = FALSE}
knitr::kable(report.incr.abs.t, caption="")
```

**Худшие показатели периода удвоения**. Для демонстрации худших показателей отобраны регионы с расчетным периодом удвоения **менее пяти недель (!)** (по среднему приросту за последние семь дней): 
